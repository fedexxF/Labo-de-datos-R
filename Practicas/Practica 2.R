...
#de que el a~no sea bisiesto.
 ...
 #Ingreso todas las variables
  ...
  Y <- as.numeric(readline("Ingrese un aÒo en formato 0000: "))


#Estan pidiendo algo que calcule  c el dia, mes y aÒo correspondiente al dia siguiente.
...
#Teniendo en cuenta los aÒos bisiestos 
  #Tener en cuenta
  #que los a~nos bisiestos son aquellos que son divisibles por 4 con la excepci¥on de los que son
  #divisibles por 100. No obstante aquellos a~nos que sean divisibles por 400 son bisiestos.
...
#Si el resto de la division entre 4 da 0 y entre 100 NO da 0, es bisiesto. O si al dividir por 400 el resto es 0.
  ...
  if((Y%%4==0 & Y%%100!=0) | Y%%400==0){           
    b <- as.numeric(29) #AÒo bisiesto con 29 dias en feb
  }else{
    b <-as.numeric(28) #AÒo NO bisiesto con 28 dias en feb
  } 
if(mes== "Enero"){
    if (DD==31){
      print(paste("dia 01 de febrero de",Y))
...
#La densidad de una poblacion de monos varƒ±a de acuerdo con la siguiente ecuacion:
#Xn+1 = 3.75 * Xn ‚ * (1 - Xn)
...
#con condicion inicial 0.8001. ¬øCual es el comportamiento observado?
...
#Nos piden que calculemos la poblacio nde monos por hecateras cada 3 meses en 20 aÒos.
...
#Aclaraci√≥n: Para resolver este ejercicio no deben usarse nociones de vectores
...
if(is.character(Materias_Aprobadas)){  #No va numeric pero no se que poner jajaja
