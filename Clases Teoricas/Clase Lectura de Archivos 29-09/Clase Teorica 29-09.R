...
# Lectura
dir_datos='~/Escritorio/LABO/Clase Teorica 29-09/Caudales01.txt';
a<-scan(dir_datos)
...
dir_datos='~/Escritorio/LABO/Clase Teorica 29-09/Caudales04.txt';
...
rm(list=ls())
dir_datos='~/Escritorio/LABO/Clase Teorica 29-09/test1.dat'
dir_datos
fid = file(dir_datos);	
